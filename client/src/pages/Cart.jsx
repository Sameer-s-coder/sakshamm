  ...
  return (
    ...
    >
      <motion.div className="text-center mb-8" variants={itemVariants}>
        <h1 className="text-3xl md:text-4xl font-bold text-[#222] mb-2">Your Shopping Cart</h1>
        <p className="text-[#333]">Review your items and proceed to checkout</p>
      </motion.div>
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="pt-4 border-t border-border">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xl font-bold text-[#222]">${total.toFixed(2)}</span>
                </div>
                {shipping === 0 && (
